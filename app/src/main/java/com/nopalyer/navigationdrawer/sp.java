...
public class sp extends AppCompatActivity {
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.lal1,R.drawable.al2, R.drawable.lal3,R.drawable.lal4, R.drawable.lal5,R.drawable.lal6,
            R.drawable.lal7,R.drawable.lal8, R.drawable.lal9,R.drawable.lal10
    ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(sp.this,FullView.class);
