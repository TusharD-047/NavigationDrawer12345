            ...
            public void onClick(View v) {
                ...
                ref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        mref.child("Mobile 1").setValue(catg.getText());
                        ...
                        mref.child("Corressponding Address").setValue(cressadd.getText());
                        mref.child("Pin 1").setValue(pin1.getText());
                        mref.child("Permanent Address").setValue(peradd.getText());
                        mref.child("Pin 2").setValue(pin2.getText());
                        mref.child("Mobile 2").setValue(mob2.getText());
                        mref.child("Hostel").setValue(hostel.getText());
                        mref.child("Semester").setValue(sem.getText());
                        mref.child("Code1").setValue(code1.getText());
                        ...
                        mref.child("Code2").setValue(code2.getText());
                        ...
                        mref.child("Code3").setValue(code3.getText());
                        ...
                        mref.child("Code4").setValue(code4.getText());
                        ...
                        mref.child("Code5").setValue(code5.getText());
                        ...
                        mref.child("Code6").setValue(code6.getText());
                        ...
                        mref.child("Code7").setValue(code7.getText());
                        ...
                        mref.child("Code8").setValue(code8.getText());
                        ...
                        mref.child("Code9").setValue(code9.getText());
                        ...
                        mref.child("Code10").setValue(code10.getText());
