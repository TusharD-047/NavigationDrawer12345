            ...
            public void onClick(View v) {
                ...
                ref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        mref.child("Mobile1").setValue(catg.getText());
                        mref.child("AcademicYear").setValue(acyr.getText());
                        ...
                        mref.child("CorresspondingAddress").setValue(cressadd.getText());
                        mref.child("Pin1").setValue(pin1.getText());
                        mref.child("PermanentAddress").setValue(peradd.getText());
                        mref.child("Pin2").setValue(pin2.getText());
                        mref.child("Mobile2").setValue(mob2.getText());
                        mref.child("Hostel").setValue(hostel.getText());
                        mref.child("Semester").setValue(sem.getText());
                        mref.child("Sub1").setValue(code1.getText());
                        mref.child("Course1").setValue(course1.getText());
                        mref.child("Lab1").setValue(lab1.getText());
                        mref.child("Credit1").setValue(credit1.getText());
                        mref.child("Sub2").setValue(code2.getText());
                        mref.child("Course2").setValue(course2.getText());
                        mref.child("Lab2").setValue(lab2.getText());
                        mref.child("Credit2").setValue(credit2.getText());
                        mref.child("Sub3").setValue(code3.getText());
                        mref.child("Course3").setValue(course3.getText());
                        mref.child("Lab3").setValue(lab3.getText());
                        mref.child("Credit3").setValue(credit3.getText());
                        mref.child("Sub4").setValue(code4.getText());
                        mref.child("Course4").setValue(course4.getText());
                        mref.child("Lab4").setValue(lab4.getText());
                        mref.child("Credit4").setValue(credit4.getText());
                        mref.child("Sub5").setValue(code5.getText());
                        mref.child("Course5").setValue(course5.getText());
                        mref.child("Lab5").setValue(lab5.getText());
                        mref.child("Credit5").setValue(credit5.getText());
                        mref.child("Sub6").setValue(code6.getText());
                        mref.child("Course6").setValue(course6.getText());
                        mref.child("Lab6").setValue(lab6.getText());
                        mref.child("Credit6").setValue(credit6.getText());
                        mref.child("Sub7").setValue(code7.getText());
                        mref.child("Course7").setValue(course7.getText());
                        mref.child("Lab7").setValue(lab7.getText());
                        mref.child("Credit7").setValue(credit7.getText());
                        mref.child("Sub8").setValue(code8.getText());
                        mref.child("Course8").setValue(course8.getText());
                        mref.child("Lab8").setValue(lab8.getText());
                        mref.child("Credit8").setValue(credit8.getText());
                        mref.child("Sub9").setValue(code9.getText());
                        mref.child("Course9").setValue(course9.getText());
                        mref.child("Lab9").setValue(lab9.getText());
                        mref.child("Credit9").setValue(credit9.getText());
                        mref.child("Sub10").setValue(code10.getText());
                        mref.child("Course10").setValue(course10.getText());
                        mref.child("Lab10").setValue(lab10.getText());
                        mref.child("Credit10").setValue(credit10.getText());
                        mref.child("CreditSum").setValue(creditsum.getText());
                        mref.child("LabSum").setValue(labsum.getText());
                        mref.child("cg1").setValue(cg1.getText());
                        mref.child("sg1").setValue(sg1.getText());
                        mref.child("rep1").setValue(rep1.getText());
                        mref.child("cg2").setValue(cg2.getText());
                        mref.child("sg2").setValue(sg2.getText());
                        mref.child("rep2").setValue(rep2.getText());
                        mref.child("cg3").setValue(cg3.getText());
                        mref.child("sg3").setValue(sg3.getText());
                        mref.child("rep3").setValue(rep3.getText());
                        mref.child("cg4").setValue(cg4.getText());
                        mref.child("sg4").setValue(sg4.getText());
                        mref.child("rep4").setValue(rep4.getText());
                        mref.child("cg5").setValue(cg5.getText());
                        mref.child("sg5").setValue(sg5.getText());
                        mref.child("rep5").setValue(rep5.getText());
                        mref.child("cg6").setValue(cg6.getText());
                        mref.child("sg6").setValue(sg6.getText());
                        mref.child("rep6").setValue(rep6.getText());
                        mref.child("cg7").setValue(cg7.getText());
                        mref.child("sg7").setValue(sg7.getText());
                        mref.child("rep7").setValue(rep7.getText());
                        mref.child("cg8").setValue(cg8.getText());
                        mref.child("sg8").setValue(sg8.getText());
                        mref.child("rep8").setValue(rep8.getText());
                        mref.child("cg9").setValue(cg9.getText());
                        mref.child("sg9").setValue(sg9.getText());
                        mref.child("rep9").setValue(rep9.getText());
