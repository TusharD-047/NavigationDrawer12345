...
public class ncc extends AppCompatActivity {
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.ncc1, R.drawable.ncc2,R.drawable.ncc3, R.drawable.ncc4,R.drawable.ncc5,
            R.drawable.ncc6,R.drawable.ncc7, R.drawable.ncc8
    ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ncc.this,FullView.class);
