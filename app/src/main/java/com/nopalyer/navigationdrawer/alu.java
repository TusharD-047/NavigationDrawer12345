...
public class alu extends AppCompatActivity {
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.hf0,R.drawable.hf1, R.drawable.hf2,R.drawable.hf3, R.drawable.hf4,R.drawable.hf5,
            R.drawable.hf6,R.drawable.hf7, R.drawable.hf8,R.drawable.hf9, R.drawable.hf10,R.drawable.hf12
    ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(alu.this,FullView.class);
