...
public class prayas extends AppCompatActivity {

    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.pr1,R.drawable.pr2, R.drawable.pr3,R.drawable.pr4, R.drawable.pr5,R.drawable.pr0,
            R.drawable.pr7,R.drawable.pr8, R.drawable.pr9,R.drawable.pr10
    ));

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prayas);
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(prayas.this,FullView.class);
