...
public class nim extends AppCompatActivity {
    ...
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.nim1,R.drawable.nim2, R.drawable.nim3,R.drawable.nim4, R.drawable.nim5,R.drawable.nim6,
            R.drawable.nim7,R.drawable.nim8, R.drawable.nim9,R.drawable.nim10
            ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(nim.this,FullView.class);
