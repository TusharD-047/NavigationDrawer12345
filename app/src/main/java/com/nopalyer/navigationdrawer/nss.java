...
public class nss extends AppCompatActivity {
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.nss1,R.drawable.nss2, R.drawable.nss3,R.drawable.nss4, R.drawable.nss5,R.drawable.nss6,
            R.drawable.nss7,R.drawable.nss8
    ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(nss.this,FullView.class);
