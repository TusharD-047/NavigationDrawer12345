...
public class hf extends AppCompatActivity {
    ...
    ArrayList<Integer> mImageIds = new ArrayList<>(Arrays.asList(
            R.drawable.hif0,R.drawable.hif1, R.drawable.hif2,R.drawable.hif3, R.drawable.hif4,R.drawable.hif5,
            R.drawable.hif6,R.drawable.hif7, R.drawable.hif8
    ));
    ...
    public void ShowDialogBox(final int item_pos){
        ...
        btn_Full.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(hf.this,FullView.class);
